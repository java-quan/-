...
},
{
    ...
    meta: { title:"论坛信息列表",authLogin:true }
},
{
...
},
{
    ...
    meta: { title:"添加论坛信息",authLogin:true }
},
{
    ...
    meta: { title:"编辑论坛信息",authLogin:true }
},
{
    ...
    meta: { title:"论坛信息详情",authLogin:true }
},
{
    path:"youqinglianjie",
...
{
    path:"tongji1",
    name:"AdmintongjiList1",
    component: () => import("@/views/tongji/list1"),
    meta: { title:"统计分析1",authLogin:true }
},
{
    path:"tongji2",
    name:"AdmintongjiList2",
    component: () => import("@/views/tongji/list2"),
    meta: { title:"统计分析2",authLogin:true }
},
{
    path:"tongji3",
    name:"AdmintongjiList3",
    component: () => import("@/views/tongji/list3"),
    meta: { title:"统计分析3",authLogin:true }
},
{
    path:"tongji4",
    name:"AdmintongjiList4",
    component: () => import("@/views/tongji/list4"),
    meta: { title:"统计分析4",authLogin:true }
},
{
    path:"tongji5",
    name:"AdmintongjiList5",
    component: () => import("@/views/tongji/list5"),
    meta: { title:"统计分析5",authLogin:true }
},
    {
        path:"hotelselect",
        name:"hotelSelect",
        component: () => import("@/views/hotel/list"),
        meta: { title:"酒店信息",authLogin:true }
    },
    {
        path:"hoteladd",
        name:"hotelAdd",
        component: () => import("@/views/hotel/add"),
        meta: { title:"添加酒店",authLogin:true }
    },

    {
        ...
        name:"hotelUpdate",
        props:route=>({id:route.query.id}),
        component: () => import("@/views/hotel/updt"),
        meta: { title:"编辑酒店",authLogin:true }
    },

    {
        ...
        meta: { title:"酒店详情",authLogin:true }
    },

    {
        path:"trafficlist",
        name:"trafficList",
        component: () => import("@/views/traffic/list"),
        meta: { title:"交通信息列表",authLogin:true }
    },
    {
        path:"trafficadd",
        name:"trafficAdd",
        component: () => import("@/views/traffic/add"),
        meta: { title:"添加交通信息",authLogin:true }
    },
    {
        path:"traficcUpdate",
        props:route=>({id:route.query.id}),
        name:"traficcUpdate",
        component: () => import("@/views/traffic/updt"),
        meta: { title:"编辑交通信息",authLogin:true }
    },
    {
        path:"trafficdetail",
        props:route=>({id:route.query.id}),
        name:"trafficdetail",
        component: () => import("@/views/traffic/detail"),
        meta: { title:"交通信息详情",authLogin:true }
    },
]
