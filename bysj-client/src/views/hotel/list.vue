    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        ...
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    <el-form-item label="酒店名称">
                        ...
                        <el-input v-model="search.hotelName"></el-input>
            ...
            >
                ...
                <el-table-column label="酒店名称" width="130">
                ...
                <el-table-column label="所在城市" width="80">
                    <template slot-scope="{row}">
                        {{ row.hotelCity}}
                    </template>
                </el-table-column>
                <el-table-column label="图片" width="100">
                    <template slot-scope="{row}">
                        <e-img :src="row.hotelPicture" type="list" style="max-width:120px"></e-img>
                    </template>
                </el-table-column>
                <el-table-column label="酒店价格" width="80">
                    <template slot-scope="{row}">
                        {{ row.hotelMoney }}
                    </template>
                </el-table-column>
                <el-table-column label="酒店星级" width="80">
                    <template slot-scope="{row}">
                        {{ row.hotelStar }}
                    </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/hoteldetail',query:{id:row.id } })"
                                           icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/hotelupdate',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.hotel.list, filter).then(res => {
                    this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm('确定删除数据？', '提示', { // 弹出 确认框提示是否要删除
                    ...
                    this.$post(api.hotel.delete, {// 提交后台
                        id: row.id
                    }).then(res => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
