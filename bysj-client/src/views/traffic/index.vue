        ...
        <div>
            <e-container>
                <div style="margin:10px 0 0 0">
                    <e-module-model-box title="交通信息列表">
                        ...
                        <el-row :gutter="30">
                            <el-col v-for="r in list" :md="6" :key="r.id" style="margin-bottom: 20px">
                                <e-module-products
                                        :title="r.trafficName"
                                        :price="r.trafficMoney" :description="r.trafficRemark"
                                        :image="r.trafficPicture"
                                        :image-height="100"
                                        :is-scale="true"
                                        :to="'/trafficwebdetail?id='+r.id">
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.traffic.weblist, filter).then(res => {
                    this.loading = false;
