...
const api = {
    ...
    hotel:{
        create:"hotel_add.do",
        list:"hotel_list.do",
        insert:"hotel_insert.do",
        update:"hotel_update.do",
        delete:"hotel_delete.do",
        detail:"hotel_detail.do",
        edit:"hotel_updt.do",
        weblist:"hotel_index.do",
        webdetail:"hotel_index_detail.do",
    },
        lvyouxianlu:{
        ...
        meishifenlei:{
            ...
            traffic:{
                create:"traffic_add.do",
                list:"traffic_list.do",
                insert:"traffic_insert.do",
                update:"traffic_update.do",
                delete:"traffic_delete.do",
                detail:"traffic_detail.do",
                edit:"traffic_updt.do",
                weblist:"traffic_index.do",
                webdetail:"traffic_index_detail.do",
            },
    }
