...
public class JingdianxinxiController extends BaseController
{
    ...
    */
    ...
    public String add()
    {
        ...
        assign("jiudianList" , new CommDAO().select("SELECT * FROM lvyou_hotel ORDER BY id desc"));
        assign("jiaotongList" , new CommDAO().select("SELECT * FROM lvyou_traffic ORDER BY id desc"));
            return json();   // 将数据写给前端
    }
    ...
    public String insert()
    {
        ...
        post.setFujinjiudian(Request.get("fujinjiudian"));
        post.setJiaotongxinxi(Request.get("jiaotongxinxi"));
    ...
    */
    ...
    public String update( Jingdianxinxi post)
    {
        _var = new LinkedHashMap(); // 重置数据
        // 创建实体类
