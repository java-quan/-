...
public class Jingdianxinxi implements Serializable {
    ...
    @Column(name = "fujinjiudian")
    private String fujinjiudian;
    @Column(name = "jiaotongxinxi")
    ...
    public String getFujinjiudian() {
        return fujinjiudian;
    }

    public void setFujinjiudian(String fujinjiudian) {
        this.fujinjiudian = fujinjiudian;
    }
